...
os.chdir('C:/Users/Milan/Dropbox/MK/ETH PhD Applied Probabilistic AI/projects_long/MT/code_new/')
...
for run in range(n_sims):
    ...
    twins_results['MTHD_adv'][3].append(hyperpar_opt_adv)    
    ...
    twins_results['MTHD_IPM'][0].append(PEHE_hat_IPM)
    twins_results['MTHD_IPM'][1].append(PEHE_hat_IPM_ot)
    twins_results['MTHD_IPM'][2].append(PEHE_hat_IPM_mt)
    twins_results['MTHD_IPM'][3].append(hyperpar_opt_IPM) 
    ...
    twins_results['TARNet_del'][3].append(hyperpar_opt_del1)
    ...
    twins_results['TARNet_imp'][3].append(hyperpar_opt_imp1)
    ...
    twins_results['TARNet_rew'][3].append(hyperpar_opt_rew1)
    ...
    twins_results['CFRWASS_del'][3].append(hyperpar_opt_del2)
    ...
    twins_results['CFRWASS_imp'][3].append(hyperpar_opt_imp2)
    ...
    twins_results['CFRWASS_rew'][3].append(hyperpar_opt_rew2)
